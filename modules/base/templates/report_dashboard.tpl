...
<div class="owa_reportSectionHeader">网站指标</div>
	...
	<TR>
		<TD style="width:50%" valign="top">
			...
			<div class="owa_reportSectionContent">
				<div class="owa_reportSectionHeader">主要内容</div>
			...
			<div class="owa_reportSectionContent">
				<div class="owa_reportSectionHeader">浏览者类型</div>	
				<div id="visitor-types" style="width:250px;margin-top:-10px;"></div>
			</div>
			
			<div class="owa_reportSectionContent">
				<div class="section_header">最新浏览</div>
		...
		<TD style="width:50%" valign="top">
			...
			<div class="owa_reportSectionContent" style="min-width:200px; height:;">
				...
				<div class="owa_genericHorizontalList owa_moreLinks">
					<UL>
						<LI>
							<a href="<?php echo $this->makeLink(array('do' => 'base.reportActionTracking'), true);?>">查看完整报告 &raquo;</a>
						</LI>
					</UL>
				</div>
				<div class="clear"></div>
			...
			<div class="owa_reportSectionContent">
				<div class="owa_reportSectionHeader">顶级推荐</div>
