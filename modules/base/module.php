...
class owa_baseModule extends owa_module {
	...
	function registerNavigation() {
		...
		$this->addNavigationSubGroup('Dashboard', 'base.reportDashboard','仪表盘 ', 1);
		//Ecommerce,,'',
		$this->addNavigationSubGroup('Ecommerce', 'base.reportEcommerce','电子商务 ',5);
		$this->addNavigationLinkInSubGroup('Ecommerce', 'base.reportRevenue','收入 ', 2);
		$this->addNavigationLinkInSubGroup('Ecommerce', 'base.reportTransactions','交易 ', 3);
		$this->addNavigationLinkInSubGroup('Ecommerce', 'base.reportVisitsToPurchase','访问要购买 ', 4);
		$this->addNavigationLinkInSubGroup('Ecommerce', 'base.reportDaysToPurchase','天要购买 ', 5);
		//Content,,'',
		$this->addNavigationSubGroup('Content', 'base.reportContent','内容 ', 4);
		$this->addNavigationLinkInSubGroup( 'Content', 'base.reportPages','页面顶部 ', 1);
		...
		//Visitors,,'',
		$this->addNavigationSubGroup( 'Visitors', 'base.reportVisitors','访问者 ', 3);
		...
		$this->addNavigationLinkInSubGroup( 'Visitors', 'base.reportVisitorsLoyalty','访问者忠诚度 ', 3);
		$this->addNavigationLinkInSubGroup( 'Visitors', 'base.reportVisitorsRecency','最近的访客 ', 4);
		$this->addNavigationLinkInSubGroup( 'Visitors', 'base.reportVisitorsAge','游客年龄 ', 5);
		...
		//Traffic,,'',
		$this->addNavigationSubGroup('Traffic', 'base.reportTraffic','交通 ', 2);
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportKeywords','搜索关键字 ', 1);
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportAnchortext','入站链接文本 ', 2);
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportSearchEngines','搜索引擎 ', 3);
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportReferringSites','参考网站 ', 4);
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportCampaigns','宣传活动 ', 5);
		...
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportCreativePerformance','创意表现 ', 8);
		$this->addNavigationLinkInSubGroup( 'Traffic', 'base.reportAttributionHistory','署名历史 ', 8);
		//Goals,,'',
